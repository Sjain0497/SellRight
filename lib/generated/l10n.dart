...
///error Verify OTP
  String get error_verify_OTP_msg {
    return Intl.message(
      'Please Enter Proper OTP',
      name: 'error_verify_otp_msg',
      desc: '',
      args: [],
    );
  }
  ...
  //Add catalouge
  String get addCatalougeName {
    return Intl.message(
      'Enter name of the catalouge',
      name: 'addCatalougeName',
      desc: '',
      args: [],
    );
  }
  ...
  /// `D'ont have any item in your cart`
  String get dont_have_any_catalouge {
    return Intl.message(
      'Don\'t have any catalouge',
      name: 'dont_have_any_catalouge',
      desc: '',
      args: [],
    );
  }
  ...
  String get dont_have_any_product {
    return Intl.message(
      'Don\'t have any product',
      name: 'dont_have_any_product',
      desc: '',
      args: [],
    );
  }
